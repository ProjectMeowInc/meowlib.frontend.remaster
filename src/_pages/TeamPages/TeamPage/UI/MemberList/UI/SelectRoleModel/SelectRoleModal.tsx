...
import { useSelectRoleModal } from "@/_pages/TeamPages/TeamPage/UI/MemberList/UI/SelectRoleModel/useSelectRoleModal"
            ...
            <div className={classes.card}>
                ...
                <div className={classes.info}>
                    ...
                    <select name={"newRole"} onChange={(event) => setRequestData(event.target.value as TeamRoleType)}>
                        <option onClick={() => setRequestData("Standard")} value="Standard">
                            Standard
                        </option>
                        <option onClick={() => setRequestData("Admin")} value={"Admin"}>
                            Admin
                        </option>
                        <option onClick={() => setRequestData("Translator")} value={"Translator"}>
                            Translator
                        </option>
                        <option onClick={() => setRequestData("Redactor")} value={"Redactor"}>
                            Redactor
                        </option>
                    </select>
                </div>
                <Button onClick={() => SubmitHandler(id)}>Сохранить</Button>
            </div>
        </div>
    )
}
