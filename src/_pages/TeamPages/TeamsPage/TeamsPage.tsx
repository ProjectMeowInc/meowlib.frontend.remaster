...
import TeamPageControls from "@/_pages/TeamPages/TeamsPage/UI/TeamPageControls/TeamPageControls"
import CreateTeam from "@/_pages/TeamPages/TeamsPage/UI/CreateTeam/CreateTeam"
    ...
    return (
        <div className={classes.wrapper}>
            ...
            <div className={classes.teams}>
                {teams.map((t) => (
                    <TeamView key={t.id} id={t.id} name={t.name} description={t.description} />
                ))}
            </div>
