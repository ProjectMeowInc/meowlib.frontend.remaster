...
import { useSelectStatusButton } from "@/_pages/BookPages/BookPage/UI/SelectStatusButton/useSelectStatusButton"
    ...
    return (
        <div className={classes.wrapper}>
            <Button onClick={ClickHandler} className={classes.btn}>
                {selectedStatus ? getPrettyBookStatusName(selectedStatus) : "Добавить в список"}
